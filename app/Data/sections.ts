...
export var sections = [
     ...
     new Section({id : 2, icon:'user', name:"About Me", headerText:"About Me", bodyText:"I am Shinjo",footerText:"None",imageURL:"null"}),
     new Section({id : 3, icon:'home', name:"Control Hub", headerText:"", bodyText:"",footerText:"",imageURL:"null"}),
     new Section({id : 4, icon:'home', name:"Authenticator", headerText:"", bodyText:"",footerText:"",imageURL:"null"})
];
